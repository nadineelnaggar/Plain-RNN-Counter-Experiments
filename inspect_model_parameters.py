...
def inspect_model_parameters():
    ...
    for run in range(num_runs):
        ...
        for epoch in range(num_epochs):
            if epoch%checkpoint_step==0 and checkpoint_count<=num_checkpoints:
                ...
                if model_name == 'VanillaLSTM':
                    ...
                    print('weight_if_0 = ', weight_if[0].detach().numpy())
                    print('weight_if_1 = ', weight_if[1].detach().numpy())
                    weights_if_0.append(weight_if[0])
                    weights_if_1.append(weight_if[1])
                    weights_ii.append(weight_ii)
                    weights_ii_0.append(weight_ii[0])
                    weights_ii_1.append(weight_ii[1])
                    weights_ig.append(weight_ig)
                    weights_ig_0.append(weight_ig[0])
                    weights_ig_1.append(weight_ig[1])
                    weights_io.append(weight_io)
                    weights_io_0.append(weight_io[0])
                    weights_io_1.append(weight_io[1])
                    ...
                    sigmoid_metrics_ft_worst_case.append(sigmoid_metric_ft_1_worst)
                    sigmoid_metrics_it_best_case.append(sigmoid_metric_it_1_best)
                    sigmoid_metrics_it_worst_case.append(sigmoid_metric_it_1_worst)
        ...
        if model_name=='VanillaLSTM':
            ...
            weights_if.append(weight_if)
            weights_if_0.append(weight_if[0].item())
            weights_if_1.append(weight_if[1].item())
            weights_ii.append(weight_ii)
            weights_ii_0.append(weight_ii[0].item())
            weights_ii_1.append(weight_ii[1].item())
            weights_ig.append(weight_ig)
            weights_ig_0.append(weight_ig[0].item())
            weights_ig_1.append(weight_ig[1].item())
            weights_io.append(weight_io)
            weights_io_0.append(weight_io[0].item())
            weights_io_1.append(weight_io[1].item())
            biases_if.append(bias_if)
            biases_ii.append(bias_ii)
            biases_ig.append(bias_ig)
            biases_io.append(bias_io)
    ...
    if model_name == 'VanillaLSTM':
        ...
        df['weights_ii_0'] = weights_ii_0
        df['weights_ii_1'] = weights_ii_1
        df1['biases_ii'] = biases_ii
        df1['weights_ig'] = weights_ig
        df['weights_ig_0'] = weights_ig_0
        df['weights_ig_1'] = weights_ig_1
        df1['biases_ig'] = biases_ig
        df1['weights_io'] = weights_io
        df['weights_io_0'] = weights_io_0
        df['weights_io_1'] = weights_io_1
