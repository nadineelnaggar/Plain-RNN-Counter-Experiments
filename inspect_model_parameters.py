        ...
        for epoch in range(num_epochs):
            if epoch%checkpoint_step==0 and checkpoint_count<=num_checkpoints:
                ...
                if model_name == 'VanillaLSTM':
                    ...
                    weights_if_0.append(weight_if[0][0])
                    weights_if_1.append(weight_if[0][1])
                    weights_ii.append(weight_ii)
                    weights_ii_0.append(weight_ii[0][0])
                    weights_ii_1.append(weight_ii[0][1])
                    weights_ig.append(weight_ig)
                    weights_ig_0.append(weight_ig[0][0])
                    weights_ig_1.append(weight_ig[0][1])
                    weights_io.append(weight_io)
                    weights_io_0.append(weight_io[0][0])
                    weights_io_1.append(weight_io[0][1])
