...
from Dyck1_Datasets import NextTokenPredictionLongTestDataset, NextTokenPredictionShortTestDataset, \
    ...
    NextTokenPredictionDataset2000tokens_nested, NextTokenPredictionDataset2000tokens_zigzag, NextTokenPredictionDataset1000tokens, NextTokenPredictionValidationDataset
    ...
    if task=='SemiDyck1MSE' or task=='SemiDyck1BCE':
        if task == 'SemiDyck1MSE':
            if model_name == 'VanillaReLURNN':
                path = path+'EXPT_LOGS/ConvergedSemiDyck1Models/MRI/'
            elif model_name == 'VanillaReLURNNCorrectInitialisation':
                path = path+'EXPT_LOGS/ConvergedSemiDyck1Models/MCI/'

            elif model_name == 'VanillaReLURNNCorrectInitialisationWithBias':
                path = path+'EXPT_LOGS/ConvergedSemiDyck1Models/MCB/'
        elif task == 'SemiDyck1BCE':
            if model_name == 'VanillaReLURNN':
                path = path+'EXPT_LOGS/ConvergedSemiDyck1Models/BRI/'


            elif model_name == 'VanillaReLURNNCorrectInitialisation':
                path = path+'EXPT_LOGS/ConvergedSemiDyck1Models/BCI/'


            elif model_name == 'VanillaReLURNNCorrectInitialisationWithBias':
                path = path+'EXPT_LOGS/ConvergedSemiDyck1Models/BCB/'
...
#        +str(hidden_size)+"_hidden_units/"+str(num_runs)+"_runs/shuffle_"+str(shuffle_dataset)+"/"
    ...
    if task=='SemiDyck1MSE' or task=='SemiDyck1BCE':
        if task == 'SemiDyck1MSE':
            if model_name == 'VanillaReLURNN':
                path = '/home/aczy098/PycharmProjects/Plain-RNN-Counter-Experiments/EXPT_LOGS/ConvergedSemiDyck1Models/MRI/'
            elif model_name == 'VanillaReLURNNCorrectInitialisation':
                path = '/home/aczy098/PycharmProjects/Plain-RNN-Counter-Experiments/EXPT_LOGS/ConvergedSemiDyck1Models/MCI/'

            elif model_name == 'VanillaReLURNNCorrectInitialisationWithBias':
                path = '/home/aczy098/PycharmProjects/Plain-RNN-Counter-Experiments/EXPT_LOGS/ConvergedSemiDyck1Models/MCB/'
        elif task == 'SemiDyck1BCE':
            if model_name == 'VanillaReLURNN':
                path = '/home/aczy098/PycharmProjects/Plain-RNN-Counter-Experiments/EXPT_LOGS/ConvergedSemiDyck1Models/BRI/'


            elif model_name == 'VanillaReLURNNCorrectInitialisation':
                path = '/home/aczy098/PycharmProjects/Plain-RNN-Counter-Experiments/EXPT_LOGS/ConvergedSemiDyck1Models/BCI/'
...
if task=='SemiDyck1MSE' or task=='SemiDyck1BCE':
    ...
    if dataset_type=='1000token':
        ...
        test_dataset=SemiDyck1TrainDataset()
    elif dataset_type=='validation':
        test_dataset=SemiDyck1ValidationDataset()
    elif dataset_type=='long_test':
        test_dataset=SemiDyck1TestDataset()
...
if task=='SemiDyck1MSE':
    if model_name=='VanillaReLURNN':
        ...
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run3_epoch24.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run4_epoch24.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run5_epoch22.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run6_epoch26.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run7_epoch26.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run8_epoch27.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run9_epoch29.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run10_epoch28.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run11_epoch26.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run12_epoch28.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run13_epoch25.pth')
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run14_epoch19.pth')
        ...
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run2_epoch29.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run3_epoch27.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run4_epoch28.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run5_epoch24.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run6_epoch29.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run8_epoch28.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run9_epoch24.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run10_epoch23.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run11_epoch27.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run12_epoch24.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run13_epoch28.pth')
        checkpoints.append(
    ...
    if model_name=='VanillaReLURNN':
        ...
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run2_epoch18.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run3_epoch9.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run4_epoch12.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run5_epoch4.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run6_epoch18.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run8_epoch21.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run9_epoch19.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run10_epoch6.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run11_epoch20.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run12_epoch29.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run13_epoch29.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run14_epoch27.pth')
        ...
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run2_epoch6.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run3_epoch29.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run4_epoch22.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run5_epoch13.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run6_epoch6.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run7_epoch26.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run8_epoch15.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run9_epoch19.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run10_epoch18.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run11_epoch29.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run12_epoch23.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run13_epoch16.pth')
        checkpoints.append(
            path + 'Dyck1_SemiDyck1BCE_25_bracket_pairs_VanillaReLURNNCorrectInitialisationWithBias_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run14_epoch24.pth')
        checkpoints.append(
