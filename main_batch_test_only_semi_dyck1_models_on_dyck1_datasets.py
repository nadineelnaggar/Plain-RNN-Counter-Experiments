...
if task=='SemiDyck1MSE':
    if model_name=='VanillaReLURNN':
        ...
        checkpoints.append(path + 'Dyck1_SemiDyck1MSE_25_bracket_pairs_VanillaReLURNNCorrectInitialisation_Feedback_EveryTimestep_1_batch_size__1hidden_units_Adam_lr=0.01_30epochs_50lr_scheduler_step_1.0lr_scheduler_gamma_20runs_CHECKPOINT_run6_epoch28.pth')
