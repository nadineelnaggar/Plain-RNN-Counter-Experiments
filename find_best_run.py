...
for i in range(len(lstm_dfs)):
    ...
    all_lstm_val_losses = []
    all_lstm_val_losses=list(np.log(lstm_dfs[i]['Average validation losses'][2:]))+list(np.log(lstm_dfs_extra_epochs[i]['Average validation losses']))
...
print('lstm average val loss change from epoch 10 to epoch 15 = ',(np.mean(lstm_val_losses_10_epochs)-np.mean(lstm_val_losses_15_epochs))/np.mean(lstm_val_losses_10_epochs) * 100,'%')
print('lstm average val loss change from epoch 15 to epoch 20 = ',(np.mean(lstm_val_losses_15_epochs)-np.mean(lstm_val_losses_20_epochs))/np.mean(lstm_val_losses_15_epochs) * 100,'%')
print('lstm average val loss change from epoch 20 to epoch 25 = ',(np.mean(lstm_val_losses_20_epochs)-np.mean(lstm_val_losses_25_epochs))/np.mean(lstm_val_losses_20_epochs) * 100,'%')
print('lstm average val loss change from epoch 25 to epoch 30 = ',(np.mean(lstm_val_losses_25_epochs)-np.mean(lstm_val_losses_30_epochs))/np.mean(lstm_val_losses_25_epochs) * 100,'%')
...
epochs = [i for i in range(5,20, 1)]
...
for i in range(len(relu_dfs)):
    ...
    # print('*********')
    plt.subplots()
    plt.plot(relu_dfs[i]['epoch'][2:20],np.log(relu_dfs[i]['Average validation losses'][2:20]), label='Validation loss')
    plt.plot(relu_dfs[i]['epoch'][2:20],np.log(relu_dfs[i]['Average train validation losses'][2:20]), label='Train loss')
    plt.plot(relu_dfs[i]['epoch'][2:20], np.log(relu_dfs[i]['Average long validation losses'][2:20]), label='Long validation loss')
    plt.legend()
...
print('relu average best epoch across 10 runs of 20 epochs = ',average_relu_best_epoch,' (assuming epoch starts at 1)')
std_relu_best_epoch=np.std(epoch_starting_1)
print('relu standard deviation of best epoch across 10 runs of 20 epochs = ',std_relu_best_epoch, '(assuming epoch starts at 1)')
...
print('relu standard deviation of corresponding val accuracy across 10 rund of 20 epochs = ',std_relu_best_val_accuracy)
...
print('relu average val loss change from epoch 10 to epoch 15 = ',(np.mean(relu_val_losses_10_epochs)-np.mean(relu_val_losses_15_epochs))/np.mean(relu_val_losses_10_epochs) * 100,'%')
print('relu average val loss change from epoch 15 to epoch 20 = ',(np.mean(relu_val_losses_15_epochs)-np.mean(relu_val_losses_20_epochs))/np.mean(relu_val_losses_15_epochs) * 100,'%')
print('relu average val loss change from epoch 20 to epoch 25 = ',(np.mean(relu_val_losses_20_epochs)-np.mean(relu_val_losses_25_epochs))/np.mean(relu_val_losses_20_epochs) * 100,'%')
print('relu average val loss change from epoch 25 to epoch 30 = ',(np.mean(relu_val_losses_25_epochs)-np.mean(relu_val_losses_30_epochs))/np.mean(relu_val_losses_25_epochs) * 100,'%')

print('**********')

print('relu average val loss at epoch 1 (assuming starting from 1) = ',np.mean(relu_val_losses_1_epochs), ', std =', np.std(relu_val_losses_1_epochs))
print('relu average val loss at epoch 2 (assuming starting from 1) = ',np.mean(relu_val_losses_2_epochs), ', std =', np.std(relu_val_losses_2_epochs))
print('relu average val loss at epoch 3 (assuming starting from 3) = ',np.mean(relu_val_losses_3_epochs), ', std =', np.std(relu_val_losses_3_epochs))
print('relu average val loss at epoch 4 (assuming starting from 4) = ',np.mean(relu_val_losses_4_epochs), ', std =', np.std(relu_val_losses_4_epochs))
print('relu average val loss at epoch 5 (assuming starting from 5) = ',np.mean(relu_val_losses_5_epochs), ', std =', np.std(relu_val_losses_5_epochs))
print('relu average val loss at epoch 6 (assuming starting from 6) = ',np.mean(relu_val_losses_6_epochs), ', std =', np.std(relu_val_losses_6_epochs))
print('relu average val loss at epoch 7 (assuming starting from 7) = ',np.mean(relu_val_losses_7_epochs), ', std =', np.std(relu_val_losses_7_epochs))
print('relu average val loss at epoch 8 (assuming starting from 8) = ',np.mean(relu_val_losses_8_epochs), ', std =', np.std(relu_val_losses_8_epochs))
print('relu average val loss at epoch 9 (assuming starting from 9) = ',np.mean(relu_val_losses_9_epochs), ', std =', np.std(relu_val_losses_9_epochs))
print('relu average val loss at epoch 10 (assuming starting from 10) = ',np.mean(relu_val_losses_10_epochs), ', std =', np.std(relu_val_losses_10_epochs))
print('relu average val loss at epoch 11 (assuming starting from 11) = ',np.mean(relu_val_losses_11_epochs), ', std =', np.std(relu_val_losses_11_epochs))
print('relu average val loss at epoch 12 (assuming starting from 12) = ',np.mean(relu_val_losses_12_epochs), ', std =', np.std(relu_val_losses_12_epochs))
print('relu average val loss at epoch 13 (assuming starting from 13) = ',np.mean(relu_val_losses_13_epochs), ', std =', np.std(relu_val_losses_13_epochs))
print('relu average val loss at epoch 14 (assuming starting from 14) = ',np.mean(relu_val_losses_14_epochs), ', std =', np.std(relu_val_losses_14_epochs))
print('relu average val loss at epoch 15 (assuming starting from 15) = ',np.mean(relu_val_losses_15_epochs), ', std =', np.std(relu_val_losses_15_epochs))
print('relu average val loss at epoch 16 (assuming starting from 16) = ',np.mean(relu_val_losses_16_epochs), ', std =', np.std(relu_val_losses_16_epochs))
print('relu average val loss at epoch 17 (assuming starting from 17) = ',np.mean(relu_val_losses_17_epochs), ', std =', np.std(relu_val_losses_17_epochs))
print('relu average val loss at epoch 18 (assuming starting from 18) = ',np.mean(relu_val_losses_18_epochs), ', std =', np.std(relu_val_losses_18_epochs))
print('relu average val loss at epoch 19 (assuming starting from 19) = ',np.mean(relu_val_losses_19_epochs), ', std =', np.std(relu_val_losses_19_epochs))
print('relu average val loss at epoch 20 (assuming starting from 20) = ',np.mean(relu_val_losses_20_epochs), ', std =', np.std(relu_val_losses_20_epochs))
print('relu average val loss at epoch 21 (assuming starting from 21) = ',np.mean(relu_val_losses_21_epochs), ', std =', np.std(relu_val_losses_21_epochs))
print('relu average val loss at epoch 22 (assuming starting from 22) = ',np.mean(relu_val_losses_22_epochs), ', std =', np.std(relu_val_losses_22_epochs))
print('relu average val loss at epoch 23 (assuming starting from 23) = ',np.mean(relu_val_losses_23_epochs), ', std =', np.std(relu_val_losses_23_epochs))
print('relu average val loss at epoch 24 (assuming starting from 24) = ',np.mean(relu_val_losses_24_epochs), ', std =', np.std(relu_val_losses_24_epochs))
print('relu average val loss at epoch 25 (assuming starting from 25) = ',np.mean(relu_val_losses_25_epochs), ', std =', np.std(relu_val_losses_25_epochs))
print('relu average val loss at epoch 26 (assuming starting from 26) = ',np.mean(relu_val_losses_26_epochs), ', std =', np.std(relu_val_losses_26_epochs))
print('relu average val loss at epoch 27 (assuming starting from 27) = ',np.mean(relu_val_losses_27_epochs), ', std =', np.std(relu_val_losses_27_epochs))
print('relu average val loss at epoch 28 (assuming starting from 28) = ',np.mean(relu_val_losses_28_epochs), ', std =', np.std(relu_val_losses_28_epochs))
print('relu average val loss at epoch 29 (assuming starting from 29) = ',np.mean(relu_val_losses_29_epochs), ', std =', np.std(relu_val_losses_29_epochs))
print('relu average val loss at epoch 30 (assuming starting from 30) = ',np.mean(relu_val_losses_30_epochs), ', std =', np.std(relu_val_losses_30_epochs))
