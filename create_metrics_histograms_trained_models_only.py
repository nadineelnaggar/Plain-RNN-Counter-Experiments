...
from Dyck1_Datasets import NextTokenPredictionDataset2000tokens_nested, NextTokenPredictionDataset2000tokens_zigzag, \
    NextTokenPredictionDataset2000tokens
...
parser.add_argument('--num_checkpoints', type=int, default=100,
                    help='number of checkpoints we want to include if we dont need all of them (e.g., first 5 checkpoints only), stop after n checkpoints')
...
if runtime == 'local':
    path = "/Users/nadineelnaggar/Google Drive/PhD/EXPT_LOGS/Dyck1_" + str(
        task) + "/Minibatch_Training/" + model_name + "/" \
...
prefix = path + 'INFERENCE_' + dataset_type + '_' + str(checkpoint_step) + 'checkpoint_step_upto' + str(
    num_checkpoints) + 'checkpoints_'
...
def create_histograms_lstm_metrics():
    ...
    plt.savefig(path + "_" + model_name + '_' + 'histogram_metrics_ft_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_metrics_it_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_metrics_ctilde_open_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_metrics_ctilde_close_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    # plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_metrics_ot_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    #################################
    plt.subplots()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_sigmoid_metrics_ft_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_sigmoid_metrics_it_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    # plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_sigmoid_metrics_ot_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_tanh_metrics_ctilde_open_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + "_" + model_name + '_' + 'histogram_tanh_metrics_ctilde_close_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
...
def create_histograms_relu_metrics():
    ...
    plt.legend(loc='upper right')
    plt.savefig(path + '_ReLURNN_histogram_metrics_TRAINED_MODELS_ONLY.png')
    plt.show()
    plt.close()
