...
train_loader = DataLoader(train_dataset[:6],batch_size=batch_size, shuffle=False, collate_fn=collate_fn)
test_loader = DataLoader(test_dataset[:6],batch_size=batch_size, shuffle=False, collate_fn=collate_fn)
long_loader = DataLoader(long_dataset[:6], batch_size=batch_size, shuffle=False, collate_fn=collate_fn)
