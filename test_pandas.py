...
from Dyck1_Datasets import NextTokenPredictionDataset900to1000tokens, NextTokenPredictionDataset502to1000tokens
...
dataset = NextTokenPredictionDataset900to1000tokens()
print(len(dataset))
count_1000=0
